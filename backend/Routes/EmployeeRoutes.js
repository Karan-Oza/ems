const {createEmployee , getAllEmployees, getAllEmployeeById, deleteEmployeeById, updateEmployeeId} = require("../Controllers/EmployeeController");
...
// update emp by id
routes.post("/", cloudinaryFileUploader.single('profileImage'), updateEmployeeId);
